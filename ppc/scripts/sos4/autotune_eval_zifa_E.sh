...
python ../model_eval_colonized.py --dataset log_poisson_zifa_dataset_12000 --n_experiments 50 \
    --zifa_coef 0.08 --zifa_lambda 1000.0 \
    --zinb_hyperparams_json log_poisson_zifa_dataset_12000_0.08_1000.0_zinb_1200_50_results.json \
    --nb_hyperparams_json log_poisson_zifa_dataset_12000_0.08_1000.0_nb_1200_50_results.json
